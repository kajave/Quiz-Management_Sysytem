...
<body>
	...
	%>
	<form action="/user/validate" style="align-self: center;" method="POST"
		id="form">
		...
		<div class="form-group">
			<label>Question Name</label> <input type="text"
				...
				value="${question.name}" name="questionname" />
		</div>
		<br>
		<div class="form-group">
			...
			<c:forEach items="${question.list}" var="list">
				...
				<input type="radio" name="option" style="margin-left: 3px"
					value="<%=c%>">
		...
		<input type="text" name="answer" value="${question.ans}" hidden="true">
